...
public enum EventTypeSlotConfig {
  ...
  EVENT2023_FOOD_SAT(EventConfig.REDANZ_EVENT, TypeSlotConfig.FOOD_SLOT_SATURDAY, FoodConfig.FOOD_BUFFET, 1),
  EVENT2023_FOOD_SUN(EventConfig.REDANZ_EVENT, TypeSlotConfig.FOOD_SLOT_SUNDAY, FoodConfig.FOOD_ASIAN, 2),
