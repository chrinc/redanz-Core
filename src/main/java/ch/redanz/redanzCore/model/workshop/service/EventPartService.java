    ...
    for (EventPartInfoConfig eventPartInfoConfig : EventPartInfoConfig.values()) {
      ...
      save(
        new EventPartInfo(
          newEvent,
          eventPart,
          outTextService.clone(eventPartInfoConfig.getTitle()),
          eventPartInfoConfig.getTitleRequired(),
          outTextService.clone(eventPartInfoConfig.getTitleExist()),
          eventPartInfoConfig.getTitleExistRequired(),
          outTextService.clone(eventPartInfoConfig.getInvalid()),
          eventPartInfoConfig.getInvalidRequired(),
          outTextService.clone(eventPartInfoConfig.getSubtitle()),
          eventPartInfoConfig.getSubtitleRequired(),
          outTextService.clone(eventPartInfoConfig.getSubtitleLink()),
          eventPartInfoConfig.getSubtitleLinkRequired(),
          outTextService.clone(eventPartInfoConfig.getHint()),
          eventPartInfoConfig.getHintRequired(),
          outTextService.clone(eventPartInfoConfig.getHintLink()),
          eventPartInfoConfig.getHintLinkRequired(),
          outTextService.clone(eventPartInfoConfig.getHint2()),
          eventPartInfoConfig.getHint2Required(),
          outTextService.clone(eventPartInfoConfig.getHint2Link()),
