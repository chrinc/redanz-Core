...
public enum EventDiscountConfig {
  EVENT_EARLY_BIRD(EventConfig.REDANZ_EVENT, DiscountConfig.EARLY_BIRD),
  EVENT_ABROAD(EventConfig.REDANZ_EVENT, DiscountConfig.ABROAD),
  EVENT_STUDENT(EventConfig.REDANZ_EVENT, DiscountConfig.STUDENT);
