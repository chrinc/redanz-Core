...
public interface SpecialRegistrationRepo extends JpaRepository<SpecialRegistration, Long> {
  ...
  int countAllBySpecialIdAndRegistration_WorkflowStatusAndRegistrationEventAndRegistrationDanceRole(Special special, WorkflowStatus workflowStatus, Event event, DanceRole danceRole);
}
