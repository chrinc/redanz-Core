...
public enum RegistrationMatchingConfig {
  NORMA_REGISTRATION  ( UserConfig.NORMA_USER.getUsername()   ,"franky_user@gmail.com", EventConfig.EVENT2023),
  WILLIAM_REGISTRATION( UserConfig.WILLIAM_USER.getUsername() ,null , EventConfig.EVENT2023),
//  ARLYNE_REGISTRATION ( UserConfig.ARLYNE_USER.getUsername()  ,null , EventConfig.EVENT2023),
//  NAOMI_REGISTRATION  ( UserConfig.NAOMI_USER.getUsername()   ,"billy_user@gmail.com" , EventConfig.EVENT2023),
//  EDDIE_REGISTRATION  ( UserConfig.EDDIE_USER.getUsername()   ,null , EventConfig.EVENT2023),
  OLIVER_REGISTRATION ( UserConfig.OLIVER_USER.getUsername()  ,null , EventConfig.EVENT2023),
  HARRY_REGISTRATION  ( UserConfig.HARRY_USER.getUsername()   ,null,  EventConfig.EVENT2023),
//  BILLY_REGISTRATION  ( UserConfig.BILLY_USER.getUsername()   ,"naomi_user@gmail.com" , EventConfig.EVENT2023),
  FRANKY_REGISTRATION ( UserConfig.FRANKY_USER.getUsername()  ,"norma_user@gmail.com", EventConfig.EVENT2023)
