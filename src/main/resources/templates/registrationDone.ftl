...
<div style="width:100%;background:#ececec;text-align:left;font-family: Arial,serif;">
    <div style="padding:15px;">
        ...
        <p>
            ${questions}<br/>
            <div class="indented italic">• ${cancellation}</div>
            <div class="indented italic">• ${refund}</div>
            <div class="indented italic">• ${ticketTransfer}</div>
            <div class="indented italic">• ${waitingLists}</div><br/>
