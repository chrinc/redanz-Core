...
<div style="width:100%; background:#ececec; text-align:left; font-family: Arial, sans-serif; font-size:16px; line-height:22px;">
    <div style="padding:15px; color:#0b0c0c;">
        ...
        <!-- BULLET POINTS (INDENTED & ITALIC) -->
        <p style="text-indent:2em; font-style:italic; margin:0 0 0 0;">• ${cancellation}</p>
        <p style="text-indent:2em; font-style:italic; margin:0 0 0 0;">• ${refund}</p>
        <p style="text-indent:2em; font-style:italic; margin:0 0 0 0;">• ${ticketTransfer}</p>
        <p style="text-indent:2em; font-style:italic; margin:0 0 20px 0;">• ${waitingLists}</p>

        <p style="margin:0 0 15px 0; font-size:16px; line-height:22px;">
            ${checkOutTerms}
            <a href="${termsUrl}" style="color:#0000ee; text-decoration:none;">${termsWebsite}</a>${checkOutTermsAt}.
        </p>
